...
https://bluexp.netapp.com/cloud-volumes-global-regions["檢視支援的 Azure 地區"^]
...
* link:https://bluexp.netapp.com/azure-netapp-files["NetApp BlueXP網站Azure NetApp Files"^]
* link:https://learn.microsoft.com/azure/azure-netapp-files/["本文檔 Azure NetApp Files"^]
* link:https://docs.netapp.com/us-en/bluexp-copy-sync/index.html["BlueXP 複本與同步文件"^]
